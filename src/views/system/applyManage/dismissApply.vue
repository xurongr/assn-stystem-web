            ...
            render: (h, params) => {
              return h('div', [
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.applyChange(params.row.id,params.row.userId,params.row.associationId,params.row.departmentId,1)
                    }
                  }
                }, '通过'),
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.applyChange(params.row.id,params.row.userId,params.row.associationId,params.row.departmentId,2)
                    }
                  }
                }, '不通过'),
                h('Button', {
